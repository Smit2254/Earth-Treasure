...
export default function InquiryModal({
  ...
  const [formData, setFormData] = useState<InquiryFormData>({
    ...
    message: directInquiryProduct ? `Hello, I want to request a wholesale quotation for ${directInquiryProduct.name}. We require custom shipping terms.` : "",
  });
  ...
  const handleSubmit = (e: React.FormEvent, submitType: "whatsapp" | "email") => {
    ...
    if (submitType === "whatsapp") {
      ...
      const encodedUrl = `https://wa.me/19985552398?text=${compiledText}`;
      ...
      setTimeout(() => {
        ...
        onClearInquiryBag();
        onClose();
        alert("Thank you! Your wholesale RFQ has been successfully registered. Our export desk will dispatch our price lists and shipping calculations within 12 business hours.");
      }, 2000);
    }
  };

  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-emerald-950/80 backdrop-blur-sm animate-fade-in" id="inquiry-system-overlay">
        ...
        <div className="p-6 md:col-span-5 flex flex-col justify-between" id="inquiry-cart-sidebar">
          <div className="space-y-4 text-left">
            ...
            {directInquiryProduct ? (
              ...
              <div className="border border-[#D4AF37]/20 rounded-xl p-4 bg-emerald-950/20 space-y-3">
                <p className="text-[10px] font-mono text-cyan-400 uppercase tracking-widest">Single Direct Product Query</p>
              ...
              <div className="py-12 text-center text-slate-500 space-y-2">
                ...
                <p className="text-[10px] max-w-xs mx-auto">Select wholesale products from our catalog to build an estimated shipping invoice.</p>
              </div>
            ) : (
              // Multi-item carts
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div className="text-left">
                        ...
                        <div className="flex items-center gap-2 mt-0.5">
                          <span className="text-[9px] text-[#D4AF37] font-mono">${item.product.priceUSD.toFixed(2)} FOB</span>
            ...
            {!directInquiryProduct && selectedItems.length > 0 && (
              <div className="border-t border-zinc-800 pt-3 flex justify-between text-xs font-mono">
                ...
                <span className="text-[#D4AF37] font-bold">
                  ${selectedItems.reduce((acc, current) => acc + (current.product.priceUSD * current.quantity), 0).toFixed(2)} USD
                </span>
              </div>
            )}
          </div>
          ...
          <div className="mt-8 rounded-lg bg-zinc-950 p-4 border border-zinc-800 text-left space-y-2">
            <div className="flex items-start gap-1.5 text-red-400">
              ...
              <p className="text-[9px] font-semibold uppercase tracking-wider font-mono">International Customs &amp; Packaging Notice</p>
            </div>
            <p className="text-[9px] text-zinc-400 leading-normal">
              Final wholesale shipping and packaging estimates will include custom heavy-duty shockproof wooden pallet crates, marine insurance, certificates of origin, and custom tariffs depending on your specified port of delivery.
            </p>
          </div>
        </div>
