  ...
  return (
    <>
              ...
              <div className='flex flex-col sm:flex-row justify-between sm:items-center gap-3 bg-slate-50 border border-slate-200 p-4 rounded-xl'>
                <div className='text-left'>
                  <p className='text-xs text-slate-500'>
                    Showing <span className='font-semibold text-slate-800'>{filteredProducts.length}</span> luxury
                    export items
                  </p>
                  {selectedCategory && (
                    ...
                    >
                      ...
                      <div className='border-t border-slate-100 p-4 space-y-3 bg-slate-50/50'>
                        ...
                        <div className='text-[10px] leading-relaxed text-slate-500 font-sans border-t border-slate-200/50 pt-2.5 italic'>
                          Export, shipping, customs duties, taxes, and handling charges are additional and will be
                          quoted separately based on destination country and order quantity.
                        </div>
      ...
      {selectedImage && (
        ...
        >
          <button className='absolute top-5 right-5 text-white text-4xl' onClick={() => setSelectedImage(null)}>
            &times;
          </button>
