...
import { ShieldCheck, Globe2, Coins, Truck, Layers, Star, Building2, ChevronRight } from 'lucide-react';
import CategoryShowcase from '../components/CategoryShowcase';
import { CATEGORIES, EXPORT_REGIONS, PRODUCTS, REVIEWS } from '../data/crystals';
...
export default function HomePage({ onQuickInquiry }: HomePageProps) {
  const navigate = useNavigate();
  return (
    <div className='animate-fade-in space-y-0 text-slate-800'>
      {/* HEROS SECTION */}
      <Hero2
        onExploreClick={() => navigate('/products/crystal-towers')}
        onRequestQuoteClick={() => navigate('/contact')}
      />

      {/* DYNAMIC PRODUCT CATEGORIES GRID SHOWCASE */}
      <CategoryShowcase categories={CATEGORIES} onSelectCategory={(catId) => navigate(`/products/${catId}`)} />
        ...
        <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
          <div className='text-center max-w-3xl mx-auto space-y-3 mb-12'>
            ...
            <p className='text-sm text-slate-500'>
              A multi-national supply chain requires complete accountability. We eliminate trade discrepancies at every
              stage.
            </p>
          </div>
          ...
          <div className='grid gap-6 sm:grid-cols-2 lg:grid-cols-3' id='features-board'>
            ...
            <div className='p-6 rounded-2xl border border-slate-100 bg-slate-50/70 hover:border-[#D4AF37]/35 hover:shadow-lg transition flex gap-4 text-left'>
              ...
              <div className='space-y-1.5'>
                ...
                <p className='text-sm text-slate-500 leading-relaxed'>
                  We operate fully integrated private mines and lapidary cutting facilities, bypassing middle trading
                  brokers to secure absolute lowest wholesale margins.
                </p>
              </div>
            </div>
            ...
            <div className='p-6 rounded-2xl border border-slate-100 bg-slate-50/70 hover:border-[#D4AF37]/35 hover:shadow-lg transition flex gap-4 text-left'>
              ...
              <div className='space-y-1.5'>
                ...
                <p className='text-sm text-slate-500 leading-relaxed'>
                  Full customs assistance, marine transport bookings, Certificates of Origin, and SGS lapidary assay
                  reports structured properly for global jurisdictions.
                </p>
              </div>
            </div>
            ...
            <div className='p-6 rounded-2xl border border-slate-100 bg-slate-50/70 hover:border-[#D4AF37]/35 hover:shadow-lg transition flex gap-4 text-left'>
              ...
              <div className='space-y-1.5'>
                ...
                <p className='text-sm text-slate-500 leading-relaxed'>
                  Every container load undergoes specialized gemological verification to ensure 100% natural mineral
                  authenticity. We never accept synthetic materials.
                </p>
              </div>
            </div>
            ...
            <div className='p-6 rounded-2xl border border-slate-100 bg-slate-50/70 hover:border-[#D4AF37]/35 hover:shadow-lg transition flex gap-4 text-left'>
              ...
              <div className='space-y-1.5'>
                ...
                <p className='text-sm text-slate-500 leading-relaxed'>
                  Our master artisans carve any dimensional specification, geode slice alignment, branded packaging, or
                  custom wellness tools according to your specifications.
                </p>
              </div>
            </div>
            ...
            <div className='p-6 rounded-2xl border border-slate-100 bg-slate-50/70 hover:border-[#D4AF37]/35 hover:shadow-lg transition flex gap-4 text-left'>
              ...
              <div className='space-y-1.5'>
                ...
                <p className='text-sm text-slate-500 leading-relaxed'>
                  Shock-insulated foam packaging and custom-fumigated timber pallets. We maintain contract agreements
                  with elite global freight forwarding networks.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className='grid gap-12 lg:grid-cols-2 lg:items-center'>
            ...
            <div className='space-y-6 text-left' id='mfc-narrative'>
              ...
              <p className='text-xs md:text-sm text-slate-600 leading-relaxed'>
                Custom wholesale crystal procurement requires deep technical compliance. At our certified polishing
                lines, skilled master craftsmen inspect raw stone structures to prevent structural micro-fractures prior
                to tooling.
              </p>
              ...
              <div className='space-y-4' id='mfc-bullet-matrix'>
                ...
                <div className='flex gap-3'>
                  ...
                  <div className='space-y-0.5'>
                    ...
                    <p className='text-xs text-slate-500'>
                      Every sea freight load is housed in certified secure solid container timber, avoiding quarantine
                      delays.
                    </p>
                  </div>
                </div>
                ...
                <div className='flex gap-3'>
                  ...
                  <div className='space-y-0.5'>
                    ...
                    <p className='text-xs text-slate-500'>
                      Full chemical grading documentation verifying natural origin properties for rapid custom clearance
                      desk audits.
                    </p>
                  </div>
                </div>
          ...
          <div className='grid gap-12 lg:grid-cols-12 lg:items-center'>
            ...
            <div className='lg:col-span-4 space-y-6 text-left'>
              ...
              <p className='text-xs md:text-sm text-slate-300 leading-relaxed'>
                Trusted by wholesale distributors, luxury spas, architectural firms, and holistic wellness brands across
                over 48 countries. We coordinate all container shipments securely.
              </p>
              ...
              <div className='relative space-y-4 max-w-lg mx-auto w-full'>
                ...
                <div className='grid gap-3 sm:grid-cols-2 text-left' id='active-cargo-blocks'>
                  <div className='p-3.5 rounded-lg bg-emerald-950 border border-emerald-900 space-y-1 hover:border-cyan-500 duration-200'>
                    ...
                    <p className='text-xs text-slate-400'>Raw Geode matrices and towers bound for New York Harbor.</p>
                  </div>
      ...
      >
        ...
        <div className='mx-auto max-w-4xl px-4 text-center space-y-6 relative z-10'>
          ...
          <p className='text-xs sm:text-sm text-slate-300 max-w-2xl mx-auto leading-relaxed'>
            Join our verified business circle today. Contact Earth Treasure for bespoke container shipments, customized
            polishing shapes, branded gemstone accessories, and custom customs brokerage.
          </p>
          <div className='pt-2'>
            <button
